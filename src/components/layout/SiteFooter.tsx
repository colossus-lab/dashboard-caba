  ...
  return (
    <footer className="site-footer" role="contentinfo">
      <div className="site-footer-grid">
        <div>
          ...
          <ul>
            ...
            <li>Ministerio de Seguridad · SNIC 2024</li>
            <li>GCBA · Datos Abiertos</li>
          </ul>
        </div>
        <div>
          ...
          <ul>
            ...
            <li>
              <a
                href="https://github.com/colossus-lab/dashboard-caba"
                target="_blank"
      ...
      <div className="site-footer-bottom">
        © {year} ColossusLab · Datos abiertos de la Ciudad Autónoma de Buenos Aires
      </div>
    </footer>
  );
}
